...
function renderHome() {
  ...
  const card = h('a', `display:block;border:${BORD};border-radius:${ptk.radius}px;padding:22px 30px;text-decoration:none;color:inherit;background:${color.panelBg};box-shadow:${ptk.shadow};animation:${ptk.floatIn};`);
  card.href = '#/solid';
  card.innerHTML = `
    <div style="font-family:${font.heading};font-weight:700;font-size:20px;">입체 탐구랩</div>
